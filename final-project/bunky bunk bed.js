...
bed = STRUCT([herm,bez,bi,b,plank])
...
var hb=COLOR([30/255,144/255,1])(STRUCT([out10,out11,outH29,outH30,outH31,outH32,out10b,out11b,outH29b,outH30b,out10i,out11i,outH29i,outH30i,outH31i,outH32i,out10bi,out11bi,outH29bi,outH30bi,outS,outS1,outS2,outS3]))


h= 1.73

var mattress = COLOR([200,200,200])(T([0,1,2])([0.9,3.3,0.1])(CUBOID([3.5-(3*dx),0.25 ,1.85-(2*dx)])))
...
var colorPillow = COLOR([2,2,2])(T([0,1,2])([3.89,3.7,0.25])(pillow))


var pillowPlusMattress = STRUCT([mattress,colorPillow])


var bed2 =STRUCT([T([1])([h])(pillowPlusMattress) ,COLOR([171/255,205/255,239/255])(T([1])([h-0.03])(bed))])
var colorBed = STRUCT([ pillowPlusMattress ,COLOR([0,127/255,1])(bed)])
...
var scale = (COLOR([1.3,1.3,1.3])(T([0,1,2])([-0.5,h+0.8,-0.888])(R([1,2])([PI/12])(S([0,1,2])([0.58,0.58,0.58])(STRUCT([steps,scaleA,scaleB,outp10,outp11,outp12,outp13]))))))


bedComplete = T([2,0])([-3.04, -0.85])(R([1,2])([PI/2])(STRUCT([bed2,colorBed,hb,scale])))
DRAW(bedComplete)
