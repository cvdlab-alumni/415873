...
base = COLOR([0.3,0.3,0.3])(arc(2*PI, 0, 1, 0.07))
h=3.2


axis = COLOR([178/255,178/255,178/255])(EXTRUDE([h])(CIRCLE(0.085)(50)))

var profile = BEZIER(S0)([[5.14-4.80,0, 3.48], [4.97-4.80,0, 3.55], [4.88-4.80, 0,3.67], [4.9-4.80, 0, 3.86]]);
var mapping = ROTATIONAL_SURFACE(profile);
var surface = COLOR([0,0,0])(T([2])([-h/2-0.1])(S([2])([0.5])(MAP(mapping)(domain))));
...
var balloon = COLOR([1,	36/255,	0,0.98])(T([2])([h-0.65])(STRUCT([surface1,surface2])));
